...
cc_apiserver_url="https://api.cloudcasa.io";
...
cc_callback_body="{\"project_id\": \"${gcp_project_id}\", \"project_name\":\"${gcp_project_name}\", \"template_version\": \"v1.0.0\", \"deployment_name\": \"${deployment_name}\"}"
